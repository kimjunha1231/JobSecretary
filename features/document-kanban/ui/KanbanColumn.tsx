...
export function KanbanColumn({ status, title, applications, onDelete, onArchiveAll }: KanbanColumnProps) {
    ...
    return (
        <div
            ref={setNodeRef}
            className={`flex-shrink-0 w-80 bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 transition-all flex flex-col ${isOver ? 'border-zinc-600 bg-zinc-900/70' : ''
                }`}
        >
