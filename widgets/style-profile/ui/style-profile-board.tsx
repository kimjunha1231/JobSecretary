...
type ProfileDraft = { name: string; endingStyle: string; preferredConnectors: string; bannedExpressions: string; exaggerationLevel: string };
...
export function StyleProfileBoard() {
    ...
    const [form, setForm] = useState({ name: '', endingStyle: '', preferredConnectors: '', bannedExpressions: '', exaggerationLevel: '', example: '' });
    ...
    const createProfile = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setForm({ name: '', endingStyle: '', preferredConnectors: '', bannedExpressions: '', exaggerationLevel: '', example: '' });
            await loadProfiles();
