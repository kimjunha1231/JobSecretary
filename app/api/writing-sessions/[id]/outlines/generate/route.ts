...
import { WritingGenerationError, generateOutlineCandidates } from '@/features/writing-studio/api';
...
export async function POST(_request: Request, { params }: RouteContext) {
    try {
        ...
        return NextResponse.json(await generateOutlineCandidates(id));
    } catch (error) {
        return errorResponse(error, '개요 후보를 생성하지 못했습니다.');
    }
}
