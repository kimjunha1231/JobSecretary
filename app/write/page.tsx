...
export default function Write() {
    ...
    const handleSave = async () => {
        if (!formData.company || sections.every(s => !s.content)) return;
        ...
        <div className="pb-20 max-w-4xl mx-auto">
            <div className="mb-8">
                <div>
                    ...
                    <p className="text-zinc-400">AI의 도움을 받아 자기소개서를 작성하세요</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="pt-4">
                    <button
                        onClick={handleSave}
                        disabled={!formData.company || sections.every(s => !s.content)}
